...
import { getProduct, useProduct } from "../redux/actions/productActions";
...
const ProductScreen = () => {
  ...
  const changeAmount = (input) => {
    if (input === "plus") setAmount(amount + 1);
    if (input === "minus") setAmount(amount - 1);
  };
  return (
    <Wrap spacing={"30px"} justify={"center"} minHeight={"100vh"}>
      {loading ? (
        ...
        <Alert status="error">
          <AlertIcon /> <AlertTitle>We are sorry!</AlertTitle>
